...
# include "window_frames_renderable2.h"
...
namespace graphics_origin {
  namespace application {
    ...
    window_frames_renderable2::storage::storage( const storage& other ) :
        center( other.center ), v1( other.v1 ), v2( other.v2 ),
        size( other.size ), depth( other.depth )
    {}

    window_frames_renderable2::storage&
    window_frames_renderable2::storage::operator=( const storage& other )
    {
      center = other.center;
      v1 = other.v1;
      v2 = other.v2;
    ...
    window_frames_renderable2::storage&
    window_frames_renderable2::storage::operator=( storage&& other )
    {
      center = other.center;
      v1 = other.v1;
      v2 = other.v2;
    ...
    window_frames_renderable2::storage::storage() :
        size( 0 ), depth( 0 )
    {}

    window_frames_renderable2::window_frames_renderable2(
    ...
    window_frames_renderable2::handle
    window_frames_renderable2::add(
    ...
    void window_frames_renderable2::update_gpu_data()
    {
      if( !m_vao )
        {
    ...
    void window_frames_renderable2::do_render()
    {
    ...
    void window_frames_renderable2::remove_gpu_data()
    {
      if( m_vao )
        {
