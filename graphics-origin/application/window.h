...
namespace graphics_origin {
  namespace application {
    ...
    public:
      ...
      /**@brief Get the number of ms spent per frame.
       *
       * Get the number of milliseconds spent to render a frame.
       * @return the averaged rendering period in milliseconds.
       */
      Q_INVOKABLE qreal get_ms_per_frame();
